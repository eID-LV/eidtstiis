...
<html lang="lv">
  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="http://eidtstiis.pmlp.gov.lv">eID</a>
          <div class="nav-collapse">
            <ul class="nav">
              <li class="active"><a href="http://eidtstiis.pmlp.gov.lv">Home</a></li>
				...
				<img style="float:right; margin-top:15px; margin-right:-35px;" src='/assets/img/arrow2.png'>
					...
					<br>Spied šeit, lai pārliecinātos, ka esi pareizi sagatavojis savu datoru darbam ar eID, un Tavs eID darbojas korekti! 
					  ...
					  class="span2">	
							 ...
							 <a href="https://eidtstiis.pmlp.gov.lv/" class="btn btn-block btn-large"><img style="float:left; width:120px; margin-right:5px" src='/assets/img/eID_logo.png'></a>
						</div>
					   <div 
					   style=" 
   ...
   <div style="margin-left:40px; text-align: justify;">  
	   ...
	   <a href="http://eidtstapa.pmlp.gov.lv">eID Autentifikācijas integrācijas piemērs izmantojot Apache</a><br>
	  ...
	  <hr>
        <p>Šī vietne darbojas uz Windows 2008 R2 Version 6.1 (build 7601, Service pack 1) un Microsoft IIS 7. Visas tiesības aizsargātas <a href="http://www.pmlp.gov.lv" target="_blank">PMLP</a> 2012. 
