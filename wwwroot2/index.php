...
<html lang="en">
  ...
  <body>
	...
	<img style="float:left; margin:20px;" src='/assets/img/eID_logo.png'>
      ...
      <h1>Uzsākt eID darbības pārbaudi</h1>
      ...
      <p>
		...
		?>
		 <a href="https://eidtstiis.pmlp.gov.lv/" class="btn btn-primary btn-large">Uzsākt pārbaudi</a>
		<?php
			} else {
       ...
       *Pirms pārbaudes uzsākšanas uz datora jābūt uzstādītam viedkaršu lasītājam un eID starpniekprogrammatūrai.
